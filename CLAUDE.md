...
- `src/RandomSkunk.StructuredLogging/` — the library, multi-targeted `net8.0;net10.0`. Ships two other assets alongside the compiled DLL: `skill/SKILL.md` (packed to `skillfiles/randomskunk-structuredlogging/SKILL.md`) and `build/RandomSkunk.StructuredLogging.targets` (packed to `buildTransitive/`).
