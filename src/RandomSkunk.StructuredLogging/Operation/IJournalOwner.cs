...
/// interpolated-string-handler argument evaluation (see <see cref="OperationLogInterpolatedStringHandler"/>'s
/// doc comment), so it always falls back to a pooled, private buffer instead - the same fallback any future
/// <see cref="ISubOperationLog"/> implementation that isn't <see cref="IJournalOwner"/> gets automatically.
/// </summary>
