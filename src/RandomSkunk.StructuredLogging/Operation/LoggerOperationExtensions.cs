...
public static class LoggerOperationExtensions
{
    ...
    /// already use - but <see cref="ISubOperationLog.EventId"/> and <see cref="ISubOperationLog.Properties"/>
    /// (via <see cref="ISubOperationLog.AddProperty{T}"/>) still behave as they would on an enabled
    ...
    /// this library's interpolated string handlers already use - but <see cref="ISubOperationLog.EventId"/>
    /// and <see cref="ISubOperationLog.Properties"/> (via <see cref="ISubOperationLog.AddProperty{T}"/>) still
